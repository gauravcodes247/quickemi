  ...
  return (
    <div className="p-6 max-w-6xl mx-auto text-gray-800 space-y-8">
      <Helmet>
        ...
        <meta name="description" content="Use our free Personal Loan EMI Calculator to estimate your monthly EMI. Simple and quick tool to plan your finances." />
        <meta name="keywords" content="personal loan emi calculator, unsecured loan emi, finance calculator, quickemi" />
        <link rel="canonical" href="https://quickemi.site/personal-loan" />
      </Helmet>

      <h1 className="text-3xl font-bold text-center mt-6">Personal Loan EMI Calculator</h1>
      ...
      <section className="bg-white p-6 mt-10 rounded-xl shadow space-y-6">
        ...
        <p className="mt-6">
          Also try: <a href="/home-loan" className="text-blue-600 underline">Home Loan EMI Calculator</a> &nbsp;|&nbsp; <a href="/car-loan" className="text-blue-600 underline">Car Loan EMI Calculator</a>
        </p>
      </section>
    </div>
  );
