...
export const metadata = {
  ...
  description:
    "Confused between personal loan and home loan EMIs? Learn the key differences in interest rates, tenures, and EMI amounts to make the right borrowing decision.",
  keywords:
    "personal loan EMI vs home loan EMI, EMI difference, types of loan EMIs, QuickEMI",
  authors: [{ name: "QuickEMI Team" }],
  robots: "index, follow",
  alternates: {
